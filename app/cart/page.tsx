// TODO: JOSH
// once side cart is complete, move that logic here
...
//                     >
//                       <div
//                         className={`relative flex w-full flex-row justify-between px-1 py-5 ${i === cart.lineItems.length - 1 && 'pb-0'} ${i === 0 && 'pt-0'}`}
//                       >
